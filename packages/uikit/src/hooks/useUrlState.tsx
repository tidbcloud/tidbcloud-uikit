...
export function UrlStateProvider(props: { children: React.ReactNode; value?: UrlStateCtxValue }) {
  ...
  return <UrlStateContext.Provider value={ctxValue}>{props.children}</UrlStateContext.Provider>
}
...
export function useUrlState<T extends UrlState = UrlState>(): [UrlStateObj<T>, (s: UrlStateObj<T>) => void] {
