...
const HelpOctagon = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'HelpOctagon', props.className].join(' ')}
    />
  )
})
