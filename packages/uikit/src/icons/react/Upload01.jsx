...
const ForwardRef = forwardRef(IconUpload01)
const Upload01 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'Upload01', props.className].join(' ')}
    />
  )
})
Upload01.displayName = 'IconUpload01'
