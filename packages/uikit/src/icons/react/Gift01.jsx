...
const ForwardRef = forwardRef(IconGift01)
const Gift01 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={[props.className, 'tiui-icon', 'Gift01'].join(' ')}
    />
  )
})
Gift01.displayName = 'IconGift01'
