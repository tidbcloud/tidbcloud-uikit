...
const IconLayoutGrid01 = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconLayoutGrid01)
const LayoutGrid01 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'LayoutGrid01', props.className].join(' ')}
    />
  )
})
LayoutGrid01.displayName = 'IconLayoutGrid01'
