...
const IconCubeOutline = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconCubeOutline)
const CubeOutline = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'CubeOutline', props.className].join(' ')}
    />
  )
})
