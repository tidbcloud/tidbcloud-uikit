...
const IconMarkerPin03 = (props, ref) => {
  return (
    ...
    >
      <path
        d="M8.00002 14.6668C8.66669 11.3335 13.3334 10.9457 13.3334 6.66683C13.3334 3.72131 10.9455 1.3335 8.00002 1.3335C5.0545 1.3335 2.66669 3.72131 2.66669 6.66683C2.66669 10.9457 7.33335 11.3335 8.00002 14.6668Z"
        stroke="currentColor"
        strokeLinecap="round"
