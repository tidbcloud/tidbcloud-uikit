...
const ForwardRef = forwardRef(IconColumns02)
const Columns02 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'Columns02', props.className].join(' ')}
    />
  )
})
Columns02.displayName = 'IconColumns02'
