...
const IconMaximize02 = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconMaximize02)
const Maximize02 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'Maximize02', props.className].join(' ')}
    />
  )
})
