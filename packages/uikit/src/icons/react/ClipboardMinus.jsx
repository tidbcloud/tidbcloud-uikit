...
const IconClipboardMinus = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconClipboardMinus)
const ClipboardMinus = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'ClipboardMinus', props.className].join(' ')}
    />
  )
})
ClipboardMinus.displayName = 'IconClipboardMinus'
