...
const IconInfoSquare = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconInfoSquare)
const InfoSquare = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'InfoSquare', props.className].join(' ')}
    />
  )
})
InfoSquare.displayName = 'IconInfoSquare'
