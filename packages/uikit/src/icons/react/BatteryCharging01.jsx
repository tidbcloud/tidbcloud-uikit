...
const IconBatteryCharging01 = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconBatteryCharging01)
const BatteryCharging01 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'BatteryCharging01', props.className].join(' ')}
    />
  )
})
BatteryCharging01.displayName = 'IconBatteryCharging01'
