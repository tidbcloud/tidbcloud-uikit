...
const IconBarChart10 = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconBarChart10)
const BarChart10 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'BarChart10', props.className].join(' ')}
    />
  )
})
BarChart10.displayName = 'IconBarChart10'
