...
const ForwardRef = forwardRef(IconStar03)
const Star03 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={[props.className, 'tiui-icon', 'Star03'].join(' ')}
    />
  )
})
Star03.displayName = 'IconStar03'
