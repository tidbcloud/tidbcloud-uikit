...
const IconFolderCheck = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const FolderCheck = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'FolderCheck', props.className].join(' ')}
    />
  )
})
