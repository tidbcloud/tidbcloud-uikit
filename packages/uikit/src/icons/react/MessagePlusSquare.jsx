...
const IconMessagePlusSquare = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconMessagePlusSquare)
const MessagePlusSquare = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'MessagePlusSquare', props.className].join(' ')}
    />
  )
})
MessagePlusSquare.displayName = 'IconMessagePlusSquare'
