...
const ForwardRef = forwardRef(IconRun1)
const Run1 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'Run1', props.className].join(' ')}
    />
  )
})
Run1.displayName = 'IconRun1'
export default Run1
