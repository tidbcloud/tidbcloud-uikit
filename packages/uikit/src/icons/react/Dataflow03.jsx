...
const IconDataflow03 = (props, ref) => {
  return (
    <svg
...
const ForwardRef = forwardRef(IconDataflow03)
const Dataflow03 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={[props.className, 'tiui-icon', 'Dataflow03'].join(' ')}
    />
  )
})
Dataflow03.displayName = 'IconDataflow03'
