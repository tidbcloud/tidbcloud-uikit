...
const IconPiggyBank01 = (props, ref) => {
  return (
    <svg
...
const ForwardRef = forwardRef(IconPiggyBank01)
const PiggyBank01 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={[props.className, 'tiui-icon', 'PiggyBank01'].join(' ')}
    />
  )
})
PiggyBank01.displayName = 'IconPiggyBank01'
