...
const UserPlus02 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'UserPlus02', props.className].join(' ')}
    />
  )
})
