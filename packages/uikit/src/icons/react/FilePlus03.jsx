...
const IconFilePlus03 = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconFilePlus03)
const FilePlus03 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'FilePlus03', props.className].join(' ')}
    />
  )
})
FilePlus03.displayName = 'IconFilePlus03'
