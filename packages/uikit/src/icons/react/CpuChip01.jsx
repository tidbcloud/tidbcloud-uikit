...
const ForwardRef = forwardRef(IconCpuChip01)
const CpuChip01 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={[props.className, 'tiui-icon', 'CpuChip01'].join(' ')}
    />
  )
})
CpuChip01.displayName = 'IconCpuChip01'
