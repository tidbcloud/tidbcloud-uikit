...
const ForwardRef = forwardRef(IconXSquare)
const XSquare = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'XSquare', props.className].join(' ')}
    />
  )
})
XSquare.displayName = 'IconXSquare'
