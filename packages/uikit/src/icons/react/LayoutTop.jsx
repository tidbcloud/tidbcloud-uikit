...
const ForwardRef = forwardRef(IconLayoutTop)
const LayoutTop = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'LayoutTop', props.className].join(' ')}
    />
  )
})
LayoutTop.displayName = 'IconLayoutTop'
