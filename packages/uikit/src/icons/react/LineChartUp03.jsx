...
const IconLineChartUp03 = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconLineChartUp03)
const LineChartUp03 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'LineChartUp03', props.className].join(' ')}
    />
  )
})
