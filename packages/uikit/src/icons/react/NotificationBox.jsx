...
const IconNotificationBox = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconNotificationBox)
const NotificationBox = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={[props.className, 'tiui-icon', 'NotificationBox'].join(' ')}
    />
  )
})
NotificationBox.displayName = 'IconNotificationBox'
