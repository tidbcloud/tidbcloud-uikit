...
const IconPiggyBank02 = (props, ref) => {
  return (
    <svg
...
const ForwardRef = forwardRef(IconPiggyBank02)
const PiggyBank02 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={[props.className, 'tiui-icon', 'PiggyBank02'].join(' ')}
    />
  )
})
PiggyBank02.displayName = 'IconPiggyBank02'
