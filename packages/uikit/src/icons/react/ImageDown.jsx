...
const ForwardRef = forwardRef(IconImageDown)
const ImageDown = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'ImageDown', props.className].join(' ')}
    />
  )
})
ImageDown.displayName = 'IconImageDown'
