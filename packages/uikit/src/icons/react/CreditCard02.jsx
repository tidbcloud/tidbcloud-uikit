...
const CreditCard02 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'CreditCard02', props.className].join(' ')}
    />
  )
})
