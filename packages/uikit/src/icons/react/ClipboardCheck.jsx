...
const IconClipboardCheck = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconClipboardCheck)
const ClipboardCheck = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'ClipboardCheck', props.className].join(' ')}
    />
  )
})
