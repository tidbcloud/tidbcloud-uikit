...
const ForwardRef = forwardRef(IconRows02)
const Rows02 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'Rows02', props.className].join(' ')}
    />
  )
})
Rows02.displayName = 'IconRows02'
