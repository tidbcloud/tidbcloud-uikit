...
const IconCalendarMinus01 = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconCalendarMinus01)
const CalendarMinus01 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'CalendarMinus01', props.className].join(' ')}
    />
  )
})
CalendarMinus01.displayName = 'IconCalendarMinus01'
