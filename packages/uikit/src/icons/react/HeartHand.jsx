...
const ForwardRef = forwardRef(IconHeartHand)
const HeartHand = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={[props.className, 'tiui-icon', 'HeartHand'].join(' ')}
    />
  )
})
HeartHand.displayName = 'IconHeartHand'
