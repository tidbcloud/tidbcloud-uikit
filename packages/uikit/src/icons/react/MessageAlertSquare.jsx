...
const IconMessageAlertSquare = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconMessageAlertSquare)
const MessageAlertSquare = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'MessageAlertSquare', props.className].join(' ')}
    />
  )
})
MessageAlertSquare.displayName = 'IconMessageAlertSquare'
