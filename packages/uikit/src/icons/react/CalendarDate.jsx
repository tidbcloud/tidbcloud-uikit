...
const IconCalendarDate = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconCalendarDate)
const CalendarDate = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'CalendarDate', props.className].join(' ')}
    />
  )
})
