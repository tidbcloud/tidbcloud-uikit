...
const IconAnnotationHeart = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconAnnotationHeart)
const AnnotationHeart = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'AnnotationHeart', props.className].join(' ')}
    />
  )
})
AnnotationHeart.displayName = 'IconAnnotationHeart'
