...
const ForwardRef = forwardRef(IconImagePlus)
const ImagePlus = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={[props.className, 'tiui-icon', 'ImagePlus'].join(' ')}
    />
  )
})
