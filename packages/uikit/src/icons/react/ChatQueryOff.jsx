...
const IconChatQueryOff = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconChatQueryOff)
const ChatQueryOff = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'ChatQueryOff', props.className].join(' ')}
    />
  )
})
ChatQueryOff.displayName = 'IconChatQueryOff'
export default ChatQueryOff
