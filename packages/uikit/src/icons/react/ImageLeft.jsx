...
const ForwardRef = forwardRef(IconImageLeft)
const ImageLeft = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'ImageLeft', props.className].join(' ')}
    />
  )
})
ImageLeft.displayName = 'IconImageLeft'
