...
const IconClipboardPlus = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconClipboardPlus)
const ClipboardPlus = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'ClipboardPlus', props.className].join(' ')}
    />
  )
})
