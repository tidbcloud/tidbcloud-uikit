...
const UsersRight = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'UsersRight', props.className].join(' ')}
    />
  )
})
