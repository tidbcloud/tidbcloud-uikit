...
const FileCheck01 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'FileCheck01', props.className].join(' ')}
    />
  )
})
