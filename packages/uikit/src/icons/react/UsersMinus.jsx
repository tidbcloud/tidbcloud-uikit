...
const IconUsersMinus = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconUsersMinus)
const UsersMinus = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'UsersMinus', props.className].join(' ')}
    />
  )
})
UsersMinus.displayName = 'IconUsersMinus'
