...
const IconPackageMinus = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconPackageMinus)
const PackageMinus = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'PackageMinus', props.className].join(' ')}
    />
  )
})
PackageMinus.displayName = 'IconPackageMinus'
