...
const ForwardRef = forwardRef(IconLogIn01)
const LogIn01 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={[props.className, 'tiui-icon', 'LogIn01'].join(' ')}
    />
  )
})
LogIn01.displayName = 'IconLogIn01'
