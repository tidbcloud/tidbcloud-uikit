...
const Image03 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'Image03', props.className].join(' ')}
    />
  )
})
