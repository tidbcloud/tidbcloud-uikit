...
const IconPlaySquare = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconPlaySquare)
const PlaySquare = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'PlaySquare', props.className].join(' ')}
    />
  )
})
PlaySquare.displayName = 'IconPlaySquare'
