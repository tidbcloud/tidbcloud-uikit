...
const IconFolderMinus = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconFolderMinus)
const FolderMinus = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'FolderMinus', props.className].join(' ')}
    />
  )
})
FolderMinus.displayName = 'IconFolderMinus'
