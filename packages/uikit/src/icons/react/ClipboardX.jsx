...
const IconClipboardX = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconClipboardX)
const ClipboardX = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'ClipboardX', props.className].join(' ')}
    />
  )
})
ClipboardX.displayName = 'IconClipboardX'
