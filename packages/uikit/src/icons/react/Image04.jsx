...
const IconImage04 = (props, ref) => {
  return (
    ...
    >
      ...
      />
      <path
        d="M6 6.33333L4 10H12L9 5L7.33333 7.33333L6 6.33333Z"
        stroke="currentColor"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth="inherit"
...
const ForwardRef = forwardRef(IconImage04)
const Image04 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'Image04', props.className].join(' ')}
    />
  )
})
Image04.displayName = 'IconImage04'
