...
const IconAnnotationInfo = (props, ref) => {
  return (
    <svg
...
const ForwardRef = forwardRef(IconAnnotationInfo)
const AnnotationInfo = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={[props.className, 'tiui-icon', 'AnnotationInfo'].join(' ')}
    />
  )
})
AnnotationInfo.displayName = 'IconAnnotationInfo'
