...
const ForwardRef = forwardRef(IconShare01)
const Share01 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={[props.className, 'tiui-icon', 'Share01'].join(' ')}
    />
  )
})
Share01.displayName = 'IconShare01'
