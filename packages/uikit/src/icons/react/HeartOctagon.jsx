...
const IconHeartOctagon = (props, ref) => {
  return (
    <svg
...
const ForwardRef = forwardRef(IconHeartOctagon)
const HeartOctagon = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={[props.className, 'tiui-icon', 'HeartOctagon'].join(' ')}
    />
  )
})
HeartOctagon.displayName = 'IconHeartOctagon'
