...
const ForwardRef = forwardRef(IconImageUp)
const ImageUp = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'ImageUp', props.className].join(' ')}
    />
  )
})
ImageUp.displayName = 'IconImageUp'
