...
const IconFolderDownload = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconFolderDownload)
const FolderDownload = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'FolderDownload', props.className].join(' ')}
    />
  )
})
FolderDownload.displayName = 'IconFolderDownload'
