...
const IconFlexAlignRight = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconFlexAlignRight)
const FlexAlignRight = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'FlexAlignRight', props.className].join(' ')}
    />
  )
})
FlexAlignRight.displayName = 'IconFlexAlignRight'
