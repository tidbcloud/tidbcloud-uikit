...
const Mail02 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'Mail02', props.className].join(' ')}
    />
  )
})
