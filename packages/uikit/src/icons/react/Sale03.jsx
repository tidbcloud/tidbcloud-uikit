...
const ForwardRef = forwardRef(IconSale03)
const Sale03 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={[props.className, 'tiui-icon', 'Sale03'].join(' ')}
    />
  )
})
Sale03.displayName = 'IconSale03'
