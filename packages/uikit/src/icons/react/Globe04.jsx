...
const ForwardRef = forwardRef(IconGlobe04)
const Globe04 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={[props.className, 'tiui-icon', 'Globe04'].join(' ')}
    />
  )
})
Globe04.displayName = 'IconGlobe04'
