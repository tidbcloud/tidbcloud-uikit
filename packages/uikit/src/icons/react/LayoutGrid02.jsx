...
const IconLayoutGrid02 = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconLayoutGrid02)
const LayoutGrid02 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'LayoutGrid02', props.className].join(' ')}
    />
  )
})
LayoutGrid02.displayName = 'IconLayoutGrid02'
