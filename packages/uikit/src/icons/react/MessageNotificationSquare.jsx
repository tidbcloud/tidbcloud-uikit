...
const ForwardRef = forwardRef(IconMessageNotificationSquare)
const MessageNotificationSquare = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={[props.className, 'tiui-icon', 'MessageNotificationSquare'].join(' ')}
    />
  )
})
