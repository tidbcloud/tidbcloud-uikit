...
const UsersUp = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'UsersUp', props.className].join(' ')}
    />
  )
})
