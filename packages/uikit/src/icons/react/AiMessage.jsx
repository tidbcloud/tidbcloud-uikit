...
const ForwardRef = forwardRef(IconAiMessage)
const AiMessage = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'AiMessage', props.className].join(' ')}
    />
  )
})
AiMessage.displayName = 'IconAiMessage'
