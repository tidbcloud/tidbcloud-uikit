...
const IconHome04 = (props, ref) => {
  return (
    ...
    >
      <path
        d="M8 10.6667C9.10457 10.6667 10 9.77123 10 8.66666C10 7.56209 9.10457 6.66666 8 6.66666C6.89543 6.66666 6 7.56209 6 8.66666C6 9.77123 6.89543 10.6667 8 10.6667Z"
        stroke="#383E40"
        strokeWidth={1.5}
        strokeLinecap="round"
...
const ForwardRef = forwardRef(IconHome04)
const Home04 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'Home04', props.className].join(' ')}
    />
  )
})
Home04.displayName = 'IconHome04'
