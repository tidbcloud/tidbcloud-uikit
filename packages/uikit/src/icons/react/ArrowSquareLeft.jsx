...
const IconArrowSquareLeft = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconArrowSquareLeft)
const ArrowSquareLeft = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'ArrowSquareLeft', props.className].join(' ')}
    />
  )
})
ArrowSquareLeft.displayName = 'IconArrowSquareLeft'
