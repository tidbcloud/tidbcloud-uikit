...
const IconPackageCheck = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconPackageCheck)
const PackageCheck = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'PackageCheck', props.className].join(' ')}
    />
  )
})
PackageCheck.displayName = 'IconPackageCheck'
