...
const IconLayoutBottom = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconLayoutBottom)
const LayoutBottom = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'LayoutBottom', props.className].join(' ')}
    />
  )
})
LayoutBottom.displayName = 'IconLayoutBottom'
