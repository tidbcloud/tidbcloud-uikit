...
const FileQuestion02 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'FileQuestion02', props.className].join(' ')}
    />
  )
})
