...
const IconImageRight = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconImageRight)
const ImageRight = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'ImageRight', props.className].join(' ')}
    />
  )
})
ImageRight.displayName = 'IconImageRight'
