...
const IconAnnotationPlus = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconAnnotationPlus)
const AnnotationPlus = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'AnnotationPlus', props.className].join(' ')}
    />
  )
})
AnnotationPlus.displayName = 'IconAnnotationPlus'
