...
const IconFeedbackSuggestion = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconFeedbackSuggestion)
const FeedbackSuggestion = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'FeedbackSuggestion', props.className].join(' ')}
    />
  )
})
FeedbackSuggestion.displayName = 'IconFeedbackSuggestion'
