...
const FolderSearch = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'FolderSearch', props.className].join(' ')}
    />
  )
})
