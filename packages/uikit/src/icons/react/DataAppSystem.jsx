...
const IconDataAppSystem = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
    ...
    >
      ...
      />
      <path
        d="M10.6665 13.4223C10.6665 14.1096 11.164 14.6667 11.7776 14.6667H12.8094C13.4668 14.6667 13.9998 14.0698 13.9998 13.3334C13.9998 12.597 13.4668 12 12.8094 12H11.857C11.1995 12 10.6665 11.4031 10.6665 10.6667C10.6665 9.93033 11.1995 9.33337 11.857 9.33337H12.8887C13.5024 9.33337 13.9998 9.89053 13.9998 10.5778"
        stroke="currentColor"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth="inherit"
...
const ForwardRef = forwardRef(IconDataAppSystem)
const DataAppSystem = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'DataAppSystem', props.className].join(' ')}
    />
  )
})
DataAppSystem.displayName = 'IconDataAppSystem'
export default DataAppSystem
