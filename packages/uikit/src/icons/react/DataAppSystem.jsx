...
const IconDataAppSystem = (props, ref) => {
  return (
    ...
    >
      ...
      />
      <path
        d="M10.667 13.4223C10.667 14.1096 11.1645 14.6667 11.7781 14.6667H12.8098C13.4673 14.6667 14.0003 14.0698 14.0003 13.3334C14.0003 12.597 13.4673 12 12.8098 12H11.8575C11.2 12 10.667 11.4031 10.667 10.6667C10.667 9.93033 11.2 9.33337 11.8575 9.33337H12.8892C13.5029 9.33337 14.0003 9.89053 14.0003 10.5778"
        stroke="#383E40"
        strokeWidth={1.5}
        strokeLinecap="round"
        strokeLinejoin="round"
