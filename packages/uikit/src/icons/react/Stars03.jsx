...
const ForwardRef = forwardRef(IconStars03)
const Stars03 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={[props.className, 'tiui-icon', 'Stars03'].join(' ')}
    />
  )
})
Stars03.displayName = 'IconStars03'
