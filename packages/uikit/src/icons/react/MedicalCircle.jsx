...
const IconMedicalCircle = (props, ref) => {
  return (
    <svg
...
const ForwardRef = forwardRef(IconMedicalCircle)
const MedicalCircle = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={[props.className, 'tiui-icon', 'MedicalCircle'].join(' ')}
    />
  )
})
MedicalCircle.displayName = 'IconMedicalCircle'
