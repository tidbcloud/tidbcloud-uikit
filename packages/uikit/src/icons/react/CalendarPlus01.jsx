...
const IconCalendarPlus01 = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconCalendarPlus01)
const CalendarPlus01 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'CalendarPlus01', props.className].join(' ')}
    />
  )
})
CalendarPlus01.displayName = 'IconCalendarPlus01'
