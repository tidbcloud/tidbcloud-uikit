...
const IconFlexAlignBottom = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconFlexAlignBottom)
const FlexAlignBottom = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'FlexAlignBottom', props.className].join(' ')}
    />
  )
})
FlexAlignBottom.displayName = 'IconFlexAlignBottom'
