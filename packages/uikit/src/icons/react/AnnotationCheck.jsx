...
const IconAnnotationCheck = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconAnnotationCheck)
const AnnotationCheck = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'AnnotationCheck', props.className].join(' ')}
    />
  )
})
AnnotationCheck.displayName = 'IconAnnotationCheck'
