...
const ForwardRef = forwardRef(IconHomeSmile)
const HomeSmile = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={[props.className, 'tiui-icon', 'HomeSmile'].join(' ')}
    />
  )
})
HomeSmile.displayName = 'IconHomeSmile'
