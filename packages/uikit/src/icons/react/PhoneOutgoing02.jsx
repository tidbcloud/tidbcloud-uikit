...
const PhoneOutgoing02 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'PhoneOutgoing02', props.className].join(' ')}
    />
  )
})
