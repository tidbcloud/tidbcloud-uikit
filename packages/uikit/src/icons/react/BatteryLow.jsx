...
const IconBatteryLow = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconBatteryLow)
const BatteryLow = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'BatteryLow', props.className].join(' ')}
    />
  )
})
BatteryLow.displayName = 'IconBatteryLow'
