...
const IconAnnotationX = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconAnnotationX)
const AnnotationX = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'AnnotationX', props.className].join(' ')}
    />
  )
})
AnnotationX.displayName = 'IconAnnotationX'
