...
const IconAnnotationQuestion = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconAnnotationQuestion)
const AnnotationQuestion = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'AnnotationQuestion', props.className].join(' ')}
    />
  )
})
AnnotationQuestion.displayName = 'IconAnnotationQuestion'
