...
const IconBarChartSquare02 = (props, ref) => {
  return (
    <svg
...
const ForwardRef = forwardRef(IconBarChartSquare02)
const BarChartSquare02 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={[props.className, 'tiui-icon', 'BarChartSquare02'].join(' ')}
    />
  )
})
