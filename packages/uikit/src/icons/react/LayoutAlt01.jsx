...
const IconLayoutAlt01 = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconLayoutAlt01)
const LayoutAlt01 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'LayoutAlt01', props.className].join(' ')}
    />
  )
})
