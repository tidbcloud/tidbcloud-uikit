...
const ForwardRef = forwardRef(IconUsersDown)
const UsersDown = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'UsersDown', props.className].join(' ')}
    />
  )
})
UsersDown.displayName = 'IconUsersDown'
