...
const IconBookOpen01 = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconBookOpen01)
const BookOpen01 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'BookOpen01', props.className].join(' ')}
    />
  )
})
BookOpen01.displayName = 'IconBookOpen01'
