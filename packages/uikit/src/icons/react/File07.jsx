...
const ForwardRef = forwardRef(IconFile07)
const File07 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'File07', props.className].join(' ')}
    />
  )
})
File07.displayName = 'IconFile07'
