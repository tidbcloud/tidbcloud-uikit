...
const Cube03 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'Cube03', props.className].join(' ')}
    />
  )
})
