...
const ForwardRef = forwardRef(IconFile05)
const File05 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'File05', props.className].join(' ')}
    />
  )
})
File05.displayName = 'IconFile05'
