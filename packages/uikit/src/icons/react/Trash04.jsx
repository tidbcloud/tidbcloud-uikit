...
const ForwardRef = forwardRef(IconTrash04)
const Trash04 = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'Trash04', props.className].join(' ')}
    />
  )
})
Trash04.displayName = 'IconTrash04'
