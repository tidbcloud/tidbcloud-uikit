...
const ShieldZap = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'ShieldZap', props.className].join(' ')}
    />
  )
})
