...
const IconFlexAlignTop = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconFlexAlignTop)
const FlexAlignTop = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'FlexAlignTop', props.className].join(' ')}
    />
  )
})
FlexAlignTop.displayName = 'IconFlexAlignTop'
