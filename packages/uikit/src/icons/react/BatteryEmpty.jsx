...
const IconBatteryEmpty = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconBatteryEmpty)
const BatteryEmpty = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'BatteryEmpty', props.className].join(' ')}
    />
  )
})
BatteryEmpty.displayName = 'IconBatteryEmpty'
