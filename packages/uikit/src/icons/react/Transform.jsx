...
const ForwardRef = forwardRef(IconTransform)
const Transform = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={[props.className, 'tiui-icon', 'Transform'].join(' ')}
    />
  )
})
Transform.displayName = 'IconTransform'
