...
const IconFolderClosed = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconFolderClosed)
const FolderClosed = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'FolderClosed', props.className].join(' ')}
    />
  )
})
FolderClosed.displayName = 'IconFolderClosed'
