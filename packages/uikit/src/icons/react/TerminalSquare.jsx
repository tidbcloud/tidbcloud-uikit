...
const IconTerminalSquare = (props, ref) => {
  return (
    <svg
      width="1em"
      height="1em"
...
const ForwardRef = forwardRef(IconTerminalSquare)
const TerminalSquare = forwardRef((props, ref) => {
  ...
  return (
    <MantineBox
      ...
      className={['tiui-icon', 'TerminalSquare', props.className].join(' ')}
    />
  )
})
TerminalSquare.displayName = 'IconTerminalSquare'
