import { Box, createStyles, ScrollArea } from '@tidb-cloud-uikit/components'
...
import { CellHeight, CellStyle } from './constant'
...
const usePickerScrollColumn = ({ min, max, curr, open, render, title }: Options) => {
