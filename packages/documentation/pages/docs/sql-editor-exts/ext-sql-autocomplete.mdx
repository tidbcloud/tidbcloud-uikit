...
## try it
You can try all the extensions playground at [here](https://tisqleditor-playground.netlify.app/?example=sql-autocomplete&with_select=&theme=oneDark) & the autocomplete extension at [here](https://tisqleditor-playground.netlify.app/?example=sql-autocomplete&theme=oneDark).
<br />
