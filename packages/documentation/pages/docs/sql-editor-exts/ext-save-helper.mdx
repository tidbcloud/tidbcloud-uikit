...
## Try it
You can try all the extensions playground at [here](https://tisqleditor-playground.netlify.app/?example=save-helper&with_select=&theme=oneDark) & the save helper extension at [here](https://tisqleditor-playground.netlify.app/?example=save-helper&theme=oneDark).
<br />
