...
### A mini Editor based on codemiiror
```ts
...
/**
 * Convert schema data to SQL config format so that the auto-complete list can be displayed when typing database/table/column name.
 */
