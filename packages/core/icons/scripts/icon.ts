...
const rawIconInputPath = path.resolve(process.cwd(), './src/raw')
const reactIconOutput = path.resolve(process.cwd(), './src/react')
const entryOutput = path.join('./src/entry.ts')
